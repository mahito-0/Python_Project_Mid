...
from models.job import add_job, view_open_jobs
...
def print_menu() -> None:
    ...
    menu_text.append("3. Post a Job\n", style="green")
    menu_text.append("4. View Open Jobs\n", style="green")
    menu_text.append("5. Apply to a Job\n", style="yellow")
    menu_text.append("6. View Applications\n", style="yellow")
    menu_text.append("7. Exit", style="red")
...
def main() -> None:
    ...
    while True:
        print_menu()
        choice: str = console.input("[bold cyan]Choose an option (1-7): [/bold cyan]").strip()
        ...
        match choice:
            ...
            case "7":
                ...
                break
            case _:
                console.print("[bold red] Invalid option. Please choose a number between 1 and 7.[/bold red]")
